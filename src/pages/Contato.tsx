...
import Jefferson from '../fotos/jeff.jpeg'
        ...
        <>
            <div className=" h-screen w-full flex items-center justify-center max-lg: m-40">
                <div className="grid grid-cols-4 max-lg:grid-cols-2 gap-16 m-5">
                    ...
                    <ProfileCard name="Jefferson Leite" profilePic={Jefferson} linkedin="https://www.linkedin.com/in/jefferson-leite-16318742/" github="https://github.com/JeffLeite91" instagram="https://www.instagram.com/jeffleite/" />
                </div>
            </div>
        </>
    )
